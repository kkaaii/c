...
enum {
	...
	bit_ACS2_supported,	/* non-standard */
	bit_ACS3_COMMANDS_ALLOWED_BY_SANITIZE,
	bit_ACS3_supported,	/* non-standard */
	bit_ACS4_supported,	/* non-standard */
	bit_ADVANCED_BACKGROUND_OPERATION_SUPPORTED,
	bit_APM_ENABLED,
	bit_APM_SUPPORTED,
	bit_ATA8_ACS_supported,	/* non-standard */
	...
	bit_EPC_ENABLED,
	bit_EPC_SUPPORTED,
	bit_ExtendedNumberOfUserAddressableSectorsSupported,	/* non-standard */
	...
	bit_IDENTIFY_DEVICE_data_is_incomplete,	/* non-standard */
	bit_IDENTIFY_DEVICE_data_word119_to_word120_are_valid,	/* non-standard */
	bit_IDENTIFY_DEVICE_data_word64_to_word70_are_valid,	/* non-standard */
	bit_IDENTIFY_DEVICE_data_word88_is_valid,	/* non-standard */
	...
	bit_media_serial_number_is_valid,	/* non-standard */
	...
	bit_standard_Standby_timer_values_supported,
	...
	bit_vendor_specific_minimum_Standby_timer_value,
...
typedef struct {
	...
	uint16	ALIGNMENT_ERROR_REPORTING		: 2;
	uint16	CURRENT_SERIAL_ATA_SIGNAL_SPEED		: 3;
	uint16	LOGICAL_SECTOR_OFFSET			: 14;
	uint16	LOGICAL_TO_PHYSICAL_SECTOR_RELATIONSHIP	: 4;
	uint16	MINIMUM_DEVSLP_ASSERTION_TIME		: 5;
	uint16	MINIMUM_INACTIVE_TIME_IN_MILLISECONDS	: 10;
	uint16	NOMINAL_FORM_FACTOR			: 4;
	uint16	NORMAL_SECURITY_ERASE_TIME		: 15;
	uint16	POWER_SOURCE				: 2;
	uint16	QUEUE_DEPTH				: 5;
	uint16	ZONED					: 2;
	...
	uint16	Inter_seek_delay;	/* non-standard */
	...
	uint16	Minor_Version_Number;	/* non-standard */
	...
	uint16	Transport_major_version_number;	/* non-standard */
	uint16	Transport_minor_version_number;	/* non-standard */
