...
,_,_,_,_,_)] = __(_) )$_(f,i)(_[_$_()____(_ ,_ ,_)] >_[  _$_()+ __$() ]  ||
_[_$_()____(_,_,_,_,_,_,_)] $_ (=,=) __$()) r(e,t) _[__(_,_,_ ,_,_ ,_)] = _
...
_[__(_,_,_,_,_)] = _[_$_() - __$()]*_[_$_() - __$()];_[__(_,_,_,_,_,_,_,_,_
)] = __(_,_)*_[__(_,_,_,_,_,_,_,_)]*_[_$_() -__$()]+ _[__ (_,_,_,_,_,_,_)];
...
])) $_(to,go) _f; $_(ar,ch) $(m,i,au)[] = <% __(_,_,_) * _$_()____(_,_), __
...
____(_,_)]++)$_$(_[_$_()____(_,_,_)] = _$()) $_(f,i)(_ [__(_,_,_,_,_,_,_) + 
